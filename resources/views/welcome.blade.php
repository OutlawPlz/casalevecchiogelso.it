...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-sans">
        <div class="bg-gray-50 text-black/75 dark:bg-black dark:text-white/75">
            <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="https://laravel.com/assets/img/welcome/background.svg" />
            <div class="relative min-h-screen flex flex-col items-center">
                <div class="relative w-full px-6">
                    <header class="grid grid-cols-2 items-center gap-2 mx-auto py-10 lg:grid-cols-3 lg:max-w-6xl">
                    ...
                    <main class="mt-6 space-y-6 lg:space-y-24">
                        <section class="grid gap-6 lg:grid-cols-5 lg:grid-rows-5 lg:gap-8">
                            <div class="rounded-xl bg-white lg:col-span-3 lg:row-span-3">
                                <!-- // -->
                            </div>

                            <div class="rounded-xl bg-white lg:row-span-2 aspect-square">
                                <!-- // -->
                            </div>
                            ...
                            <div class="rounded-xl bg-white lg:col-span-2 lg:row-span-3">
                                <!-- // -->
                            </div>

                            <div class="rounded-xl bg-white lg:col-span-2 row-span-2">
                                <!-- // -->
                            </div>
                        </section>

                        <section class="grid gap-8 mx-auto lg:grid-cols-2 lg:max-w-6xl">
                            <div>
