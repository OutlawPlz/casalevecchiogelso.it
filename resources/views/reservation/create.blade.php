                            ...
                            <div class="flex justify-end">
                                <div
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div>
                                            <x-text-input class="rounded-b-none relative focus:z-10" type="text"
                                                          name="name" required placeholder="{{ __('Name') }}"/>
                                            <x-text-input class="rounded-t-none relative -top-px focus:z-10"
                                        ...
                                        <div class="relative mt-4">
                                            ...
                                            <div class="relative flex justify-center text-sm font-medium leading-6">
                                                <span
                                                    class="bg-gray-50 px-4 text-gray-0">{{ __('Or continue with') }}</span>
                                            </div>
                                        </div>
