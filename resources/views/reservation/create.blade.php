                            ...
                            <div class="flex justify-end">
                                <div class="border border-gray-300 bg-gray-50 border-dashed rounded-lg prose px-5 py-3 max-w-[90%]">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <a href="{{ route('social.redirect', ['google', ...$reservation]) }}" class="mt-4 flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent">
