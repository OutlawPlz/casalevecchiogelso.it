...
$variantClasses = match ($variant) {
    ...
    'primary' => 'bg-zinc-800 hover:bg-zinc-900 dark:bg-white dark:hover:bg-zinc-100 text-white dark:text-zinc-800  shadow-[inset_0px_1px_var(--color-zinc-900),inset_0px_2px_--theme(--color-white/.15)] dark:shadow-none',
