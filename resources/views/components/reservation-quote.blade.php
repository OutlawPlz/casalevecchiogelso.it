            ...
            >
                ...
                <div class="relative mt-4">
                    ...
                    <div class="relative flex justify-center text-sm font-medium leading-6">
                        <span class="bg-zinc-50 px-4 text-zinc-0">{{ __('Or continue with') }}</span>
                    </div>
                </div>

                <a
                    href="{{ route('social.redirect', ['google']) }}"
                    class="mt-4 flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-zinc-900 shadow-xs ring-1 ring-inset ring-zinc-300 hover:bg-zinc-50 focus-visible:ring-transparent"
                >
